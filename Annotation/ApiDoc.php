...
class ApiDoc
{
    ...
    public function __construct(array $data)
    {
        ...
        if (isset($data['customHeaders'])) {           
            foreach ($data['customHeaders'] as $customHeader) {
                if (!isset($customHeader['name'])) {
                    throw new \InvalidArgumentException('A "customHeader" element has to contain a "name" attribute');
                }

                if (!isset($customHeader['dataType'])) {
                    throw new \InvalidArgumentException(sprintf(
                        '"%s" customHeader element has to contain a "dataType" attribute',
                        $customHeader['name']
                    ));
                }
                ...
                $this->addCustomHeader($name, $customHeader);
            }
        }
    ...
    public function toArray()
    {
        ...
        if ($customHeaders = $this->customHeaders) {
     ...
     */
    public function addCustomHeader($name, array $customHeader)
    {
        $this->customHeaders[$name] = $customHeader;
    }
